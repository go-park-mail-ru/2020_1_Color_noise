...
func (m *MockIUsecase) IsFollowed(id, subId uint) (bool, error) {
	m.ctrl.T.Helper()
...
func (mr *MockIUsecaseMockRecorder) IsFollowed(id, subId interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "IsFollowed", reflect.TypeOf((*MockIUsecase)(nil).IsFollowed), id, subId)
}
...
func (m *MockIUsecase) UpdatePreferences(userId uint, preferences []string) error {
	m.ctrl.T.Helper()
...
func (mr *MockIUsecaseMockRecorder) UpdatePreferences(userId, preferences interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdatePreferences", reflect.TypeOf((*MockIUsecase)(nil).UpdatePreferences), userId, preferences)
}
