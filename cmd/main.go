...
func main() {
	...
	r.HandleFunc("/api/user/settings/profile", userDelivery.UpdateUser).Methods("PUT")
	r.HandleFunc("/api/user/settings/password", userDelivery.UpdatePassword).Methods("PUT")
	r.HandleFunc("api/user/settings/avatar", userDelivery.UploadAvatar).Methods("POST")
